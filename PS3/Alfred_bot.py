...
#starts with a random list of items as an example of something that would make our 
#utility utilizer bot ineffective

class RandomBot(BaseNegotiator):
    def __init__(self):
        super().__init__()
	...
	def what_utility(self):
		#find the utility of possible offers
	
	def accept_offer(self):
		#if offer is 90% of our max utility or greater - take it
		#if offer is 50% or less of max - reject it
